<?php
$pageTitle = 'Édition Produit - Imprixo Admin';
$pageDescription = '';
...
<!-- Header -->
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <h2 class="text-3xl font-black text-gray-900 mb-8" id="page-title">✏️ Édition Produit</h2>

        <!-- Tabs -->
        <div class="bg-white rounded-xl shadow-lg mb-6">
            <div class="flex border-b">
                <div class="tab active px-6 py-4 font-bold" onclick="switchTab('general')">📝 Général</div>
                <div class="tab px-6 py-4 font-bold" onclick="switchTab('prices')">💰 Prix</div>
                <div class="tab px-6 py-4 font-bold" onclick="switchTab('config')">⚙️ Configurateur</div>
                <div class="tab px-6 py-4 font-bold" onclick="switchTab('promo')">🔥 Promotion</div>
            </div>
        </div>
        ...
        <form id="product-form">
            ...
            <div id="tab-general" class="tab-content">
                <div class="bg-white rounded-xl shadow-lg p-8 mb-6">
                    <h3 class="text-2xl font-black mb-6">📝 Informations générales</h3>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Délai livraison (jours)</label>
                        ...
                        <div>
                            ...
                            <input type="text" id="certification" placeholder="Ex: M1 - Ignifugé" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-red-600 focus:outline-none">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="tab-prices" class="tab-content hidden">
                <div class="bg-white rounded-xl shadow-lg p-8 mb-6">
                    <h3 class="text-2xl font-black mb-6">💰 Grille tarifaire</h3>
                    <p class="text-gray-600 mb-6">Prix au m² selon la surface commandée</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <span class="bg-gray-200 px-4 py-3 border-2 border-l-0 border-gray-300 rounded-r-lg font-bold">€/m²</span>
                            </div>
                        </div>
            ...
            <div id="tab-config" class="tab-content hidden">
                <div class="bg-white rounded-xl shadow-lg p-8 mb-6">
                    <h3 class="text-2xl font-black mb-6">⚙️ Options du configurateur</h3>
                    
                    <div class="mb-6">
                        <label class="block text-sm font-bold text-gray-700 mb-3">Formats prédéfinis</label>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <p class="text-sm text-gray-600 mb-3">8 formats standards (A0, A1, Roll-up, Panneaux, Grands formats, Personnalisé)</p>
            ...
            <div id="tab-promo" class="tab-content hidden">
                <div class="bg-white rounded-xl shadow-lg p-8 mb-6">
                    <h3 class="text-2xl font-black mb-6">🔥 Promotion</h3>
                    ...
                    <div id="promo-fields" class="hidden space-y-6">
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Prix promotionnel (€/m²)</label>
                        ...
                        <div>
                            ...
                            <input type="text" id="promo_titre" placeholder="Ex: -20% pour Noël !" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-red-600 focus:outline-none">
                        </div>
                        ...
                        <div>
                            <label class="flex items-center gap-3 cursor-pointer">
                                ...
                                <span class="font-bold">Afficher un compte à rebours</span>
                            </label>
                        </div>
    ...
    function loadProduct() {
        ...
        if (isNew) {
            document.getElementById('page-title').textContent = '➕ Nouveau Produit';
