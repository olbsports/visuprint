...
<body class="bg-gray-50">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3" id="format-selector">
                            ...
                            <div class="config-option rounded-lg p-3 text-center" data-format="A1 (59×84 cm)" data-w="59" data-h="84" data-custom="false">
                                <div class="font-semibold text-sm">A1 (59×84 cm)</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="A2 (42×59 cm)" data-w="42" data-h="59" data-custom="false">
                                <div class="font-semibold text-sm">A2 (42×59 cm)</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="A3 (30×42 cm)" data-w="30" data-h="42" data-custom="false">
                                <div class="font-semibold text-sm">A3 (30×42 cm)</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="A4 (21×30 cm)" data-w="21" data-h="30" data-custom="false">
                                <div class="font-semibold text-sm">A4 (21×30 cm)</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Kakemono 85×200 cm" data-w="85" data-h="200" data-custom="false">
                                <div class="font-semibold text-sm">Kakemono 85×200 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Kakemono 100×200 cm" data-w="100" data-h="200" data-custom="false">
                                <div class="font-semibold text-sm">Kakemono 100×200 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Roll-up 85×200 cm" data-w="85" data-h="200" data-custom="false">
                                <div class="font-semibold text-sm">Roll-up 85×200 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Roll-up 100×200 cm" data-w="100" data-h="200" data-custom="false">
                                <div class="font-semibold text-sm">Roll-up 100×200 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Roll-up 120×200 cm" data-w="120" data-h="200" data-custom="false">
                                <div class="font-semibold text-sm">Roll-up 120×200 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="X-Banner 60×160 cm" data-w="60" data-h="160" data-custom="false">
                                <div class="font-semibold text-sm">X-Banner 60×160 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="X-Banner 80×180 cm" data-w="80" data-h="180" data-custom="false">
                                <div class="font-semibold text-sm">X-Banner 80×180 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="L-Banner 80×200 cm" data-w="80" data-h="200" data-custom="false">
                                <div class="font-semibold text-sm">L-Banner 80×200 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Panneau 40×60 cm" data-w="40" data-h="60" data-custom="false">
                                <div class="font-semibold text-sm">Panneau 40×60 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Panneau 60×80 cm" data-w="60" data-h="80" data-custom="false">
                                <div class="font-semibold text-sm">Panneau 60×80 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Panneau 80×120 cm" data-w="80" data-h="120" data-custom="false">
                                <div class="font-semibold text-sm">Panneau 80×120 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Panneau 100×150 cm" data-w="100" data-h="150" data-custom="false">
                                <div class="font-semibold text-sm">Panneau 100×150 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Carré 50×50 cm" data-w="50" data-h="50" data-custom="false">
                                <div class="font-semibold text-sm">Carré 50×50 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Carré 80×80 cm" data-w="80" data-h="80" data-custom="false">
                                <div class="font-semibold text-sm">Carré 80×80 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Carré 100×100 cm" data-w="100" data-h="100" data-custom="false">
                                <div class="font-semibold text-sm">Carré 100×100 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="200×100 cm" data-w="200" data-h="100" data-custom="false">
                                <div class="font-semibold text-sm">200×100 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="300×100 cm" data-w="300" data-h="100" data-custom="false">
                                <div class="font-semibold text-sm">300×100 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="300×200 cm" data-w="300" data-h="200" data-custom="false">
                                <div class="font-semibold text-sm">300×200 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="400×200 cm" data-w="400" data-h="200" data-custom="false">
                                <div class="font-semibold text-sm">400×200 cm</div>
                            </div>
                            <div class="config-option rounded-lg p-3 text-center" data-format="Personnalisé" data-w="100" data-h="100" data-custom="true">
                                <div class="font-semibold text-sm">Personnalisé</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-600 mt-2">
                            <i class="fas fa-lightbulb text-yellow-500"></i> Vous pouvez aussi commander maintenant et envoyer votre fichier plus tard
                        </p>
                    </div>
                    ...
                    <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-6">
                        <h3 class="font-bold text-blue-900 mb-3">
                            <i class="fas fa-clipboard-list"></i> Résumé de votre configuration
                        </h3>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-6">
                    ...
                    <div class="bg-green-50 border-2 border-green-500 p-4 rounded-lg">
                        ...
                        <p class="text-sm text-green-800">Fabrication européenne certifiée. Livraison dans toute l'Europe en $delai jours ouvrés.</p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-24 bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-6">
                        ...
                        <div class="text-center p-3 bg-gray-50 rounded-lg">
                            <div class="text-2xl mb-1"><i class="fas fa-truck text-green-600"></i></div>
                            <div class="text-xs font-bold text-gray-700">Livraison {$delai}j</div>
                        </div>
                        <div class="text-center p-3 bg-gray-50 rounded-lg">
                            <div class="text-2xl mb-1"><i class="fas fa-check-circle text-green-600"></i></div>
                            <div class="text-xs font-bold text-gray-700">Qualité garantie</div>
                        </div>
                        <div class="text-center p-3 bg-gray-50 rounded-lg">
                            <div class="text-2xl mb-1"><i class="fas fa-lock text-gray-600"></i></div>
    ...
    <script>
    // Toggle specs collapsible - Fonction globale
    ...
    window.addEventListener('load', function() {
        ...
        console.log('Formats trouvés:', formatElements.length);

        formatElements.forEach(el => {
            el.addEventListener('click', function(e) {
                e.preventDefault();
                console.log('Format cliqué:', this.dataset.format);
                ...
                if (customDims) {
                    customDims.style.display = isCustom ? 'grid' : 'none';
                }

                if (!isCustom) {
                    const largeurEl = document.getElementById('largeur');
                    const hauteurEl = document.getElementById('hauteur');
                    if (largeurEl) largeurEl.value = config.largeur;
                    if (hauteurEl) hauteurEl.value = config.hauteur;
                }
        ...
        // Premier format sélectionné par défaut - avec timeout
        setTimeout(function() {
            const firstFormat = document.querySelector('[data-format]');
            if (firstFormat) {
                console.log('Sélection du premier format');
                firstFormat.click();
            } else {
                console.error('Aucun format trouvé!');
            }
        }, 100);
        ...
        // Options finition
        const finitionElements = document.querySelectorAll('[data-option]');
        console.log('Finitions trouvées:', finitionElements.length);

        finitionElements.forEach(el => {
            el.addEventListener('click', function(e) {
                e.preventDefault();
                console.log('Finition cliquée:', this.dataset.option);
