...
<head>
    ...
    <title>Dibond Alu 2mm - Imprixo</title>
    <meta name="description" content="Dibond Alu 2mm ✓ Prix dégressifs 58.0€→40.0€/m² ✓ Livraison 3j ✓ M1 - Ignifugé">
    <link rel="canonical" href="https://imprixo.fr/produit/DB-2MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            code: 'DB-2MM',
            nom: 'Dibond Alu 2mm',
            sous_titre: 'Aluminium composite - Léger',
            desc_courte: 'Composite aluminium 2mm ultra-léger',
            desc_longue: 'Panneau composite aluminium 2 faces + âme polyéthylène. Ultra-léger mais rigide. Parfait enseignes intérieures haut de gamme, panneaux décoratifs. Finition mate ou brillante. Ne rouille jamais. Aspect professionnel premium.',
            ...
            // Photos produits
            photos: [
                '/assets/products/DB-2MM-1.jpg',
                '/assets/products/DB-2MM-2.jpg',
                '/assets/products/DB-2MM-3.jpg'
            ]
        };
