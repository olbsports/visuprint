...
<head>
    ...
    <title>Kavalan 360 B1 - Imprixo</title>
    <meta name="description" content="Kavalan 360 B1 ✓ Prix dégressifs 20.0€→12.8€/m² ✓ Livraison 3j ✓ B1">
    <link rel="canonical" href="https://imprixo.fr/produit/KAVALAN-360-B1.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            code: 'KAVALAN-360-B1',
            nom: 'Kavalan 360 B1',
            sous_titre: 'Textile Kavalan',
            desc_courte: 'Support textile Kavalan 360 B1',
            desc_longue: 'Support textile professionnel Kavalan 360 B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.',
            ...
            // Photos produits
            photos: [
                '/assets/products/KAVALAN-360-B1-1.jpg',
                '/assets/products/KAVALAN-360-B1-2.jpg',
                '/assets/products/KAVALAN-360-B1-3.jpg'
            ]
        };
