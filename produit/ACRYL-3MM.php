...
<head>
    ...
    <title>Acrylique Transparent 3mm - Imprixo</title>
    <meta name="description" content="Acrylique Transparent 3mm ✓ Prix dégressifs 56.0€→40.0€/m² ✓ Livraison 3j ✓ M3">
    <link rel="canonical" href="https://imprixo.fr/produit/ACRYL-3MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            ...
            sous_titre: 'PMMA - Transparent brillant',
            desc_courte: 'Plexiglass transparent pour affichage luxe',
            desc_longue: 'Panneau acrylique (PMMA) transparent brillant. Effet vitrine premium. Idéal présentoirs luxe, PLV haut de gamme, signalétique moderne. Transparence cristalline. Résistant chocs. Facile à nettoyer. Attention : impression UV uniquement.',
            ...
            // Photos produits
            photos: [
                '/assets/products/ACRYL-3MM-1.jpg',
                '/assets/products/ACRYL-3MM-2.jpg',
                '/assets/products/ACRYL-3MM-3.jpg'
            ]
        };
