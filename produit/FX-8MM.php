...
<head>
    ...
    <title>Forex 8mm (PVC Foam) - Imprixo</title>
    <meta name="description" content="Forex 8mm (PVC Foam) ✓ Prix dégressifs 58.0€→40.0€/m² ✓ Livraison 3j ✓ M1 - Ignifugé">
    <link rel="canonical" href="https://imprixo.fr/produit/FX-8MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            ...
            sous_titre: 'PVC Foam - Haute rigidité',
            desc_courte: 'PVC expansé 8mm ultra-rigide',
            desc_longue: 'Panneau PVC expansé 8mm ultra-rigide. Structure renforcée grands formats. Ne gondole jamais. Parfait enseignes pro, panneaux architecturaux, structures autoportantes. Excellente résistance mécanique et climatique. M1.',
            ...
            // Photos produits
            photos: [
                '/assets/products/FX-8MM-1.jpg',
                '/assets/products/FX-8MM-2.jpg',
                '/assets/products/FX-8MM-3.jpg'
            ]
        };
