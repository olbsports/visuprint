...
<head>
    ...
    <title>Dibond Alu 3mm - Imprixo</title>
    <meta name="description" content="Dibond Alu 3mm ✓ Prix dégressifs 58.0€→40.0€/m² ✓ Livraison 3j ✓ M1 - Ignifugé">
    <link rel="canonical" href="https://imprixo.fr/produit/DB-3MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            code: 'DB-3MM',
            nom: 'Dibond Alu 3mm',
            sous_titre: 'Aluminium composite - Standard pro',
            desc_courte: 'Composite aluminium 3mm - Standard professionnel',
            desc_longue: 'Panneau composite 2 faces alu + âme polyéthylène. LE standard enseignes professionnelles. Rigidité exceptionnelle, ne gondole jamais. Résistance extrême UV, pluie, vent. Finition mate, brillante ou brossée. Garantie 10+ ans extérieur. Idéal façades, enseignes durables, signalétique urbaine.',
            ...
            impression_faces: 'Simple ou double',
            delai: 3,
            prix: {
                '0-10': 58.0,
                '11-50': 52.0,
            ...
            min_commande_m2: 1,
            min_quantite: 1,
            // Fonds perdus standard (en cm)
            fonds_perdu: 0.3,
            // Photos produits
            photos: [
                '/assets/products/DB-3MM-1.jpg',
                '/assets/products/DB-3MM-2.jpg',
                '/assets/products/DB-3MM-3.jpg'
            ]
        };
        ...
        function ProductPage() {
            ...
            const [prixOptions, setPrixOptions] = useState(0);
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
                                <h2 className="text-2xl font-black text-gray-900 mb-6">⚙️ Configurez votre produit</h2>
                                ...
                                <!-- Specs techniques VISIBLES -->
                                <div className="spec-badge rounded-lg p-4 mb-6">
                                    <h3 className="font-bold text-blue-900 mb-3">📐 Dimensions finales avec fonds perdus</h3>
                                ...
                                <div className="mb-6">
                                    ...
                                    >
                                        ...
                                        <option value="Double face - même visuel">Double face - même visuel (×1.5)</option>
                                        <option value="Double face - visuels différents">Double face - visuels différents (×1.8)</option>
                                    </select>
                                </div>

                                <!-- OPTIONS CONFIGURABLES -->
                                <h3 className="text-xl font-black text-gray-900 mb-4 mt-8">🎨 Options supplémentaires</h3>
                        ...
                        <div className="lg:col-span-1">
                            <div className="price-sidebar bg-white rounded-xl shadow-lg p-6">
                                ...
                                <button className="w-full border-2 border-gray-300 text-gray-700 py-3 rounded-lg font-bold hover:border-red-600 hover:text-red-600 transition">
                                    Demander un devis
                                </button>
                                ...
                                <div className="grid grid-cols-2 gap-3 mt-6">
                                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <div className="text-xs font-bold text-gray-700">Livraison rapide</div>
                                    </div>
                                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                                        <div className="text-2xl mb-1">🔒</div>
                                        <div className="text-xs font-bold text-gray-700">Paiement sécurisé</div>
                                    </div>
                                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                                        <div className="text-2xl mb-1">✓</div>
                                        <div className="text-xs font-bold text-gray-700">Garantie qualité</div>
                                    </div>
                                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                                        <div className="text-2xl mb-1">⭐</div>
