...
<head>
    ...
    <title>Mesh 330 B1 Double-Sided - Imprixo</title>
    <meta name="description" content="Mesh 330 B1 Double-Sided ✓ Prix dégressifs 25.0€→16.0€/m² ✓ Livraison 3j ✓ B1">
    <link rel="canonical" href="https://imprixo.fr/produit/MESH-330-B1-DOUBLE-SIDED.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            ...
            sous_titre: 'Textile Mesh',
            desc_courte: 'Support textile Mesh 330 B1 Double-Sided',
            desc_longue: 'Support textile professionnel Mesh 330 B1 Double-Sided. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.',
            ...
            // Photos produits
            photos: [
                '/assets/products/MESH-330-B1-DOUBLE-SIDED-1.jpg',
                '/assets/products/MESH-330-B1-DOUBLE-SIDED-2.jpg',
                '/assets/products/MESH-330-B1-DOUBLE-SIDED-3.jpg'
            ]
        };
