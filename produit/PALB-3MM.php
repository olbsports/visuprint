...
<head>
    ...
    <title>Palboard 3mm - Imprixo</title>
    <meta name="description" content="Palboard 3mm ✓ Prix dégressifs 52.0€→36.0€/m² ✓ Livraison 3j ✓ Non classé">
    <link rel="canonical" href="https://imprixo.fr/produit/PALB-3MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            code: 'PALB-3MM',
            nom: 'Palboard 3mm',
            sous_titre: 'PVC alvéolaire - Haut de gamme',
            desc_courte: 'PVC alvéolaire léger et résistant',
            desc_longue: 'Panneau PVC alvéolaire haute qualité. Structure nid d\'abeille ultra-résistante. Très léger mais rigide. Parfait PLV premium, présentoirs, totems. Excellente tenue couleurs. Surface lisse parfaite impression. Recyclable.',
            ...
            // Photos produits
            photos: [
                '/assets/products/PALB-3MM-1.jpg',
                '/assets/products/PALB-3MM-2.jpg',
                '/assets/products/PALB-3MM-3.jpg'
            ]
        };
