...
<head>
    ...
    <title>Samba 195g B1 - Imprixo</title>
    <meta name="description" content="Samba 195g B1 ✓ Prix dégressifs 22.0€→14.1€/m² ✓ Livraison 3j ✓ B1">
    <link rel="canonical" href="https://imprixo.fr/produit/SAMBA-195G-B1.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            code: 'SAMBA-195G-B1',
            nom: 'Samba 195g B1',
            sous_titre: 'Textile Samba',
            desc_courte: 'Support textile Samba 195g B1',
            desc_longue: 'Support textile professionnel Samba 195g B1. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.',
            ...
            // Photos produits
            photos: [
                '/assets/products/SAMBA-195G-B1-1.jpg',
                '/assets/products/SAMBA-195G-B1-2.jpg',
                '/assets/products/SAMBA-195G-B1-3.jpg'
            ]
        };
