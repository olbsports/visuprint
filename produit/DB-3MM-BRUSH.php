...
<head>
    ...
    <title>Dibond Alu 3mm Brossé - Imprixo</title>
    <meta name="description" content="Dibond Alu 3mm Brossé ✓ Prix dégressifs 60.0€→45.0€/m² ✓ Livraison 3j ✓ M1 - Ignifugé">
    <link rel="canonical" href="https://imprixo.fr/produit/DB-3MM-BRUSH.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            ...
            sous_titre: 'Aluminium brossé - Prestige',
            desc_courte: 'Composite aluminium brossé effet métal',
            desc_longue: 'Panneau Dibond 3mm finition brossée premium. Aspect aluminium brossé du plus bel effet. Qualité prestige pour enseignes haut de gamme, plaques professionnelles, signalétique luxe. Résistance maximale extérieur. Garantie 10+ ans.',
            ...
            // Photos produits
            photos: [
                '/assets/products/DB-3MM-BRUSH-1.jpg',
                '/assets/products/DB-3MM-BRUSH-2.jpg',
                '/assets/products/DB-3MM-BRUSH-3.jpg'
            ]
        };
