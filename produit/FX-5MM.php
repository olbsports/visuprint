...
<head>
    ...
    <title>Forex 5mm (PVC Foam) - Imprixo</title>
    <meta name="description" content="Forex 5mm (PVC Foam) ✓ Prix dégressifs 45.0€→30.0€/m² ✓ Livraison 3j ✓ M1 - Ignifugé">
    <link rel="canonical" href="https://imprixo.fr/produit/FX-5MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            ...
            sous_titre: 'PVC Foam - Rigidité supérieure',
            desc_courte: 'PVC expansé 5mm pour enseignes durables',
            desc_longue: 'Panneau PVC expansé 5mm renforcé. Excellente rigidité, ne fléchit pas. Idéal enseignes extérieures, panneaux chantier, affichage permanent. Résiste UV et intempéries. Classement M1.',
            ...
            // Photos produits
            photos: [
                '/assets/products/FX-5MM-1.jpg',
                '/assets/products/FX-5MM-2.jpg',
                '/assets/products/FX-5MM-3.jpg'
            ]
        };
