...
<head>
    ...
    <title>Easy Mesh 270 - Imprixo</title>
    <meta name="description" content="Easy Mesh 270 ✓ Prix dégressifs 9.0€→5.8€/m² ✓ Livraison 3j ✓ M2">
    <link rel="canonical" href="https://imprixo.fr/produit/EASY-MESH-270.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            code: 'EASY-MESH-270',
            nom: 'Easy Mesh 270',
            sous_titre: 'Textile Easy',
            desc_courte: 'Support textile Easy Mesh 270',
            desc_longue: 'Support textile professionnel Easy Mesh 270. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.',
            ...
            // Photos produits
            photos: [
                '/assets/products/EASY-MESH-270-1.jpg',
                '/assets/products/EASY-MESH-270-2.jpg',
                '/assets/products/EASY-MESH-270-3.jpg'
            ]
        };
