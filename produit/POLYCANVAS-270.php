...
<head>
    ...
    <title>Polycanvas 270 - Imprixo</title>
    <meta name="description" content="Polycanvas 270 ✓ Prix dégressifs 24.0€→15.4€/m² ✓ Livraison 3j ✓ M2">
    <link rel="canonical" href="https://imprixo.fr/produit/POLYCANVAS-270.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            code: 'POLYCANVAS-270',
            nom: 'Polycanvas 270',
            sous_titre: 'Textile Polycanvas',
            desc_courte: 'Support textile Polycanvas 270',
            desc_longue: 'Support textile professionnel Polycanvas 270. Impression HD haute définition. Idéal pour événementiel, stands, kakémonos, roll-ups.',
            ...
            // Photos produits
            photos: [
                '/assets/products/POLYCANVAS-270-1.jpg',
                '/assets/products/POLYCANVAS-270-2.jpg',
                '/assets/products/POLYCANVAS-270-3.jpg'
            ]
        };
