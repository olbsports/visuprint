...
<head>
    ...
    <title>Forex 2mm (PVC Foam) - Imprixo</title>
    <meta name="description" content="Forex 2mm (PVC Foam) ✓ Prix dégressifs 32.0€→20.0€/m² ✓ Livraison 3j ✓ M1 - Ignifugé">
    <link rel="canonical" href="https://imprixo.fr/produit/FX-2MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            ...
            sous_titre: 'PVC Foam - Ultra léger',
            desc_courte: 'PVC expansé 2mm pour affichage léger',
            desc_longue: 'Panneau PVC expansé ultra-léger 2mm. Structure alvéolaire fine. Parfait pour kakémonos légers, affichage intérieur temporaire. Facile à découper et percer. Classement au feu M1.',
            ...
            // Photos produits
            photos: [
                '/assets/products/FX-2MM-1.jpg',
                '/assets/products/FX-2MM-2.jpg',
                '/assets/products/FX-2MM-3.jpg'
            ]
        };
