...
<head>
    ...
    <title>HIPS 3mm - Imprixo</title>
    <meta name="description" content="HIPS 3mm ✓ Prix dégressifs 38.0€→26.0€/m² ✓ Livraison 3j ✓ Non classé">
    <link rel="canonical" href="https://imprixo.fr/produit/HIPS-3MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            code: 'HIPS-3MM',
            nom: 'HIPS 3mm',
            sous_titre: 'Polystyrène choc - Alternatif malin',
            desc_courte: 'Alternative entre Forex et Dibond',
            desc_longue: 'Panneau HIPS (High Impact Polystyrene) 3mm. Rigidité proche Dibond, prix proche Forex. Excellente alternative économique. Résistant aux chocs. Parfait pour enseignes boutiques, PLV semi-permanente, panneaux intérieurs. Bonne tenue extérieur abrité. Finition brillante.',
            ...
            // Photos produits
            photos: [
                '/assets/products/HIPS-3MM-1.jpg',
                '/assets/products/HIPS-3MM-2.jpg',
                '/assets/products/HIPS-3MM-3.jpg'
            ]
        };
