...
<head>
    ...
    <title>Forex 3mm (PVC Foam) - Imprixo</title>
    <meta name="description" content="Forex 3mm (PVC Foam) ✓ Prix dégressifs 32.0€→20.0€/m² ✓ Livraison 3j ✓ M1 - Ignifugé">
    <link rel="canonical" href="https://imprixo.fr/produit/FX-3MM.php">
...
<body class="bg-gray-50">
    ...
    <script type="text/babel">
        ...
        const PRODUCT_DATA = {
            ...
            sous_titre: 'PVC Foam - Standard polyvalent',
            desc_courte: 'PVC expansé 3mm - Le plus populaire',
            desc_longue: 'Panneau PVC expansé 3mm, standard du marché. Structure alvéolaire légère et rigide. Excellent rapport qualité/prix. Résistant aux intempéries. Facile à travailler. Impression HD. Classement M1. Parfait pour enseignes, panneaux, PLV, stands.',
            ...
            // Photos produits
            photos: [
                '/assets/products/FX-3MM-1.jpg',
                '/assets/products/FX-3MM-2.jpg',
                '/assets/products/FX-3MM-3.jpg'
            ]
        };
